...
{
    public sealed class EfAnswerRepository : EfEntityRepositoryBase<Answer, NeDersinDbContext>, IAnswerRepository
    {
        public EfAnswerRepository(NeDersinDbContext context) : base(context) { }
    }
}
