...
namespace NeDersin.Infrastructure.Repositoryies.Concrete
{
    ...
    public sealed class EfUserRepository : EfEntityRepositoryBase<User, NeDersinDbContext>, IUserRepository
    {
        public EfUserRepository(NeDersinDbContext context) : base(context) { }
    }
}
