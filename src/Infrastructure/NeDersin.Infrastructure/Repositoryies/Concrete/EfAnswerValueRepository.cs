...
{
    public sealed class EfAnswerValueRepository : EfEntityRepositoryBase<AnswerValue, NeDersinDbContext>, IAnswerValueRepository
    {
        public EfAnswerValueRepository(NeDersinDbContext context) : base(context) { }
    }
}
