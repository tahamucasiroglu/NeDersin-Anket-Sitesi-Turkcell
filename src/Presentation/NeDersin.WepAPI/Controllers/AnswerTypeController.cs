...
namespace NeDersin.WepAPI.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class AnswerTypeController : BasePostController<AddAnswerTypeRequestDTO, UpdateAnswerTypeRequestDTO, DeleteAnswerTypeRequestDTO, GetAnswerTypeResponseDTO>
    {
        
        private readonly IAnswerTypeService answerTypeService;

        public AnswerTypeController(IAnswerTypeService answerTypeService, HateoasEnumeration hateoasEnumeration, ILogger<AnswerTypeController> logger) : base(answerTypeService, hateoasEnumeration.GetAnswerControllerHateoas, logger)
        {
        ...
        public IActionResult GetById([FromBody] IdModel Id)
        {
            ...
            IReturnModel<GetAnswerTypeResponseDTO> result = answerTypeService.GetById(Id.Id);
